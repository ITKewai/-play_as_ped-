...
Config.Staff_elements = {
    ...
    {label = 'Bambino Mafioso',          value = 19, ped = "Child"},
    {label = 'Dante Default',          value = 20, ped = "Dante"},
    {label = 'Dante Nero',          value = 21, ped = "Paolino"},
    {label = 'Dante Castano',          value = 22, ped = "dante2"},
    {label = 'Ragazzino Trans',          value = 23, ped = "abner"},
    {label = 'Neonato',          value = 24, ped = "skin_baby"},
    {label = 'Batman',          value = 25, ped = "BatmanBVS"},
    {label = 'Groot Medio',          value = 26, ped = "minibabygroot"},
    {label = 'Groot Piccolo',          value = 27, ped = "littlegroot"},
    {label = 'Toretto',          value = 28, ped = "u_m_m_aldinapoli"},
    {label = 'Ghostface',          value = 29, ped = "Ghostface"},
    {label = 'Deadpool',          value = 30, ped = "Deadpool"},
    {label = 'Alex Intellettuale',          value = 31, ped = "alex_weiss"},
    {label = 'Paul Walker',          value = 32, ped = "brian_o"},
    {label = 'Prete',          value = 33, ped = "cs_priest"},
    {label = 'Jesu',          value = 34, ped = "u_m_m_jesus_01"},
    {label = 'Robot',          value = 35, ped = "u_m_y_juggernaut_01"},
    {label = 'Tipo Barbuto',          value = 36, ped = "a_m_m_hasjew_01"},
    {label = 'Uomo Mascherato',          value = 37, ped = "mp_m_bogdangoon"},
    {label = 'Uomo Scimmia',          value = 38, ped = "u_m_m_streetart_01"},
    {label = 'Uomo Sciammia2',          value = 39, ped = "u_m_y_pogo_01"},
    {label = 'Alieno',          value = 40, ped = "s_m_m_movalien_01"},
    {label = 'Astronauta',          value = 41, ped = "s_m_m_movspace_01"},
    {label = 'Big Foot',          value = 42, ped = "cs_orleans"},
    {label = 'Uomo senza Testa',          value = 43, ped = "ig_johnnyklebitz"},
    {label = 'Spiderman',          value = 44, ped = "Spiderman_Raimi_PS4"},

}


Config.Public_elements = {
